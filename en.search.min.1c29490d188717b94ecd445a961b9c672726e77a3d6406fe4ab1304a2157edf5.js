...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-backend/flexsearch.min.js');loadScript('/study-backend/en.search-data.min.c846ceeec6c9dad6de894ff910daa8e39a0ef9511a8f12b93736ba5d9cbe62e9.js',function(){input.required=false;search();});}
