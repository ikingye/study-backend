...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-backend/flexsearch.min.js');loadScript('/study-backend/en.search-data.min.c6199ec2e60964794d89e089698888ef4dfa28a4e0774f5a42a4b8d858598696.js',function(){input.required=false;search();});}
