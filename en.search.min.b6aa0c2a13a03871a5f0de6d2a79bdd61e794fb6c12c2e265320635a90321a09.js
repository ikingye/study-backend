...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-backend/flexsearch.min.js');loadScript('/study-backend/en.search-data.min.2898c746ac3858ff3fba49403de89fac159affeed562a9b3081f384ff4325ee6.js',function(){input.required=false;search();});}
