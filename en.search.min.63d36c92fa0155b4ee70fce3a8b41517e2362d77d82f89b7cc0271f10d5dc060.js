...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-backend/flexsearch.min.js');loadScript('/study-backend/en.search-data.min.7414dba305ce30d305bccba8b83fb5a5db06ba52b75c89aabde25a552a19cf58.js',function(){input.required=false;search();});}
